...
import { Leaf, Upload, Camera, MapPin, Calendar, Send, Type, FileText, CheckCircle2 } from "lucide-react"
                ...
                <div className="flex justify-center mt-10">
                  <Button
                    ...
                    className="bg-gradient-to-r from-green-600 to-green-700 text-white border-none rounded-full 
                              ...
                              hover:from-green-700 hover:to-green-800 hover:shadow-lg hover:scale-105 flex items-center gap-3"
                  >
